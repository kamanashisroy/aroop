...
public class aroopp.CodeWriter : CodeVisitor {
	...
	public void write_file (CodeContext context, string filename) {
		...
		var temp_filename = filename + ".aroopptmp";
	...
	public override void visit_catch_clause (CatchClause clause) {
		var type_name = clause.error_type == null ? "aroopp.Error" : clause.error_type.to_string ();
	...
	private void write_identifier (string s) {
		...
		if (context.profile != Profile.DOVA &&
		    (aroopp.Scanner.get_identifier_or_keyword (id, id_length) != aroopp.TokenType.IDENTIFIER ||
		     s.get_char ().isdigit ())) {
			stream.putc ('@'); 
		}
		write_string (s);
	...
	private void write_attributes (CodeNode node) {
		...
		var attributes = new aroopp.Sequence<Attribute> ();
		...
		while (!iter.is_end ()) {
			...
			var keys = new aroopp.Sequence<string> ();
...
public enum aroopp.CodeWriterType {
	EXTERNAL,
	INTERNAL,
	FAST,
	DUMP
