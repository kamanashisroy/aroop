 ...
 */
public class aroopp.TryStatement : CodeNode, Statement {
	/**
	...
	private Set<CatchClause> catch_clauses = new ArrayList<CatchClause> ();
	 ...
	 */
	public Set<CatchClause> get_catch_clauses () {
