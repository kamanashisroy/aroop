 ...
 */
public class aroopp.Interface : ObjectTypeSymbol {
	private Set<DataType> prerequisites = new ArrayList<DataType> ();

	private Set<Method> methods = new ArrayList<Method> ();
	private Set<Field> fields = new ArrayList<Field> ();
	private Set<Constant> constants = new ArrayList<Constant> ();
	private Set<Property> properties = new ArrayList<Property> ();
	private Set<Signal> signals = new ArrayList<Signal> ();

	// inner types
	private Set<Class> classes = new ArrayList<Class> ();
	private Set<Struct> structs = new ArrayList<Struct> ();
	private Set<Enum> enums = new ArrayList<Enum> ();
	private Set<Delegate> delegates = new ArrayList<Delegate> ();
	 ...
	 */
	public Set<Delegate> get_delegates () {
		return delegates;
	}
	 ...
	 */
	public Set<DataType> get_prerequisites () {
	 ...
	 */
	public override Set<Method> get_methods () {
		return methods;
	}
	 ...
	 */
	public Set<Constant> get_constants () {
		return constants;
	}
	 ...
	 */
	public override Set<Property> get_properties () {
		return properties;
	}
	 ...
	 */
	public override Set<Signal> get_signals () {
		return signals;
	}
