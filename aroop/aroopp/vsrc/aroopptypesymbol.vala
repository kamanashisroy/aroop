...
/**
 * Represents a runtime data type. This data type may be defined in aroopp source
 * code or imported from an external library with a aroopp API file.
 */
public abstract class aroopp.TypeSymbol : Symbol {
