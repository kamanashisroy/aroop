...
/**
 * Code visitor parsing all aroopp source files.
 */
public class aroopp.Parser : CodeVisitor {
	Scanner scanner;
	...
	static Set<TypeParameter> _empty_type_parameter_list;
	...
	/**
	 * Parses all .aroopp and .vapi source files in the specified code
	...
	DataType parse_type (bool owned_by_default, bool can_weak_ref) throws ParseError {
		...
		if (!is_dynamic && value_owned == owned_by_default && accept (TokenType.VOID)) {
			...
			Set<DataType> type_arg_list = parse_type_argument_list (false);
	...
	Set<Expression> parse_argument_list () throws ParseError {
	...
	Expression parse_simple_name () throws ParseError {
		...
		Set<DataType> type_arg_list = parse_type_argument_list (true);
	...
	Set<Expression> parse_expression_list () throws ParseError {
		var list = new ArrayList<Expression> ();
		do {
	...
	Expression parse_array_creation_expression () throws ParseError {
		...
		Set<Expression> size_specifier_list = null;
		bool first = true;
		do {
			if (!first) {
	...
	Set<MemberInitializer> parse_object_initializer () throws ParseError {
	...
	Expression parse_lambda_expression () throws ParseError {
		var begin = get_location ();
		Set<Parameter> params = new ArrayList<Parameter> ();
		if (accept (TokenType.OPEN_PARENS)) {
			if (current () != TokenType.CLOSE_PARENS) {
				do {
	...
	void parse_catch_clauses (Set<CatchClause> catch_clauses) throws ParseError {
	...
	Set<Attribute>? parse_attributes () throws ParseError {
	...
	void set_attributes (CodeNode node, Set<Attribute>? attributes) {
		if (attributes != null) {
			foreach (Attribute attr in (Set<Attribute>) attributes) {
	...
	void parse_namespace_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	void parse_class_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	void parse_constant_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var access = parse_access_modifier ();
	...
	void parse_method_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var access = parse_access_modifier ();
		var flags = parse_member_declaration_modifiers ();
		var type = parse_type (true, false);
	...
	void parse_property_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var access = parse_access_modifier ();
		var flags = parse_member_declaration_modifiers ();
		var type = parse_type (true, true);
	...
	void parse_signal_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var access = parse_access_modifier ();
		var flags = parse_member_declaration_modifiers ();
	...
	void parse_constructor_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var flags = parse_member_declaration_modifiers ();
	...
	void parse_destructor_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var flags = parse_member_declaration_modifiers ();
	...
	void parse_struct_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var access = parse_access_modifier ();
		var flags = parse_type_declaration_modifiers ();
	...
	void parse_interface_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var access = parse_access_modifier ();
		var flags = parse_type_declaration_modifiers ();
	...
	void parse_enum_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var access = parse_access_modifier ();
		var flags = parse_type_declaration_modifiers ();
	...
	void parse_errordomain_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var access = parse_access_modifier ();
		var flags = parse_type_declaration_modifiers ();
	...
	void parse_creation_method_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var access = parse_access_modifier ();
		var flags = parse_member_declaration_modifiers ();
		var sym = parse_symbol_name ();
	...
	void parse_delegate_declaration (Symbol parent, Set<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var access = parse_access_modifier ();
		var flags = parse_member_declaration_modifiers ();
	...
	Set<TypeParameter> parse_type_parameter_list () throws ParseError {
	...
	Set<DataType>? parse_type_argument_list (bool maybe_expression) throws ParseError {
		var begin = get_location ();
		if (accept (TokenType.OP_LT)) {
...
public errordomain aroopp.ParseError {
	FAILED,
	SYNTAX
}
