 ...
 */
public class aroopp.CreationMethod : Method {
	/**
		...
		if (body != null) {
			...
			if (!chain_up && cl != null && cl.base_class != null) {
				if (context.profile == Profile.GOBJECT
					...
					var stmt = new ExpressionStatement (new MethodCall (new MemberAccess (new MemberAccess.simple ("aroopp", source_reference), "Object", source_reference), source_reference), source_reference);
