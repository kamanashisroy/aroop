 ...
 */
public class aroopp.SemanticAnalyzer : CodeVisitor {
	...
	public Set<CodeNode> replaced_nodes = Set<CodeNode> ();
	...
	public void analyze (CodeContext context) {
		...
		if (context.profile == Profile.GOBJECT) {
			var aroopp_ns = root_symbol.scope.lookup ("aroopp");

			object_type = (Class) aroopp_ns.scope.lookup ("Object");
			type_type = new IntegerType ((Struct) aroopp_ns.scope.lookup ("Type"));
			gvalue_type = new StructValueType ((Struct) aroopp_ns.scope.lookup ("Value"));
			gvariant_type = new ObjectType ((Class) aroopp_ns.scope.lookup ("Variant"));

			glist_type = new ObjectType ((Class) aroopp_ns.scope.lookup ("List"));
			gslist_type = new ObjectType ((Class) aroopp_ns.scope.lookup ("SList"));
			garray_type = new ObjectType ((Class) aroopp_ns.scope.lookup ("Array"));
			gvaluearray_type = new ObjectType ((Class) aroopp_ns.scope.lookup ("ValueArray"));

			gerror_type = (Class) aroopp_ns.scope.lookup ("Error");
			regex_type = new ObjectType ((Class) root_symbol.scope.lookup ("aroopp").scope.lookup ("Regex"));
	...
	public static DataType get_data_type_for_symbol (TypeSymbol sym) {
		...
		Set<TypeParameter> type_parameters = null;
	...
	public bool check_arguments (Expression expr, DataType mtype, Set<Parameter> params, Set<Expression> args) {
