 ...
 */
public class aroopp.Namespace : Symbol {
	private Set<Class> classes = Set<Class> ();
	private Set<Interface> interfaces = Set<Interface> ();
	private Set<Struct> structs = Set<Struct> ();
	private Set<Enum> enums = Set<Enum> ();
	private Set<ErrorDomain> error_domains = Set<ErrorDomain> ();
	private Set<Delegate> delegates = Set<Delegate> ();
	private Set<Constant> constants = Set<Constant> ();
	private Set<Field> fields = Set<Field> ();
	private Set<Method> methods = Set<Method> ();

	private Set<Comment> comments = Set<Comment> ();

	private Set<Namespace> namespaces = Set<Namespace> ();

	private Set<UsingDirective> using_directives = Set<UsingDirective> ();
	 ...
	 */
	public Set<Namespace> get_namespaces () {
		return namespaces;
	}
	 ...
	 */
	public Set<Interface> get_interfaces () {
		return interfaces;
	}
	 ...
	 */
	public Set<ErrorDomain> get_error_domains () {
