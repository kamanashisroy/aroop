 ...
 * be defined in aroopp source code or imported from an external library with a 
 * aroopp API file.
 */
public abstract class aroopp.ObjectTypeSymbol : TypeSymbol {
