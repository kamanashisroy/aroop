 ...
 */
public class aroopp.MemberAccess : Expression {
	/**
	...
	private Set<DataType> type_argument_list = new ArrayList<DataType> ();
	 ...
	 */
	public Set<DataType> get_type_arguments () {
	...
	public override void get_defined_variables (Set<Variable> collection) {
		if (inner != null) {
			inner.get_defined_variables (collection);
		}
	}

	public override void get_used_variables (Set<Variable> collection) {
		if (inner != null) {
