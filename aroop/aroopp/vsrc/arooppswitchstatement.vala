 ...
 */
public class aroopp.SwitchStatement : CodeNode, Statement {
	/**
	...
	private Set<SwitchSection> sections = Set<SwitchSection> ();
	 ...
	 * @return section list
	 */
	public Set<SwitchSection> get_sections () {
		return sections;
	}
