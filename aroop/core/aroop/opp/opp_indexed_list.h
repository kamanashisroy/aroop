...
#define OPP_INDEXED_LIST_CREATE2(olist, pool_size, property) ({opp_indexed_list_create2_and_profile(olist, pool_size, property, __FILE__, __LINE__, AROOP_MODULE_NAME);})
