...
public class Vala.AroopValueModule : AroopObjectModule {
	...
	public override void visit_struct (Struct st) {
		...
		generate_class_declaration ((Class) context.root.scope.lookup ("Aroop").scope.lookup ("Value"), cfile);

		var base_type = new CCodeFunctionCall (new CCodeIdentifier ("aroop_value_type_get"));

		var base_type_size = new CCodeFunctionCall (new CCodeIdentifier ("aroop_type_get_type_size"));
		...
		type_init_block.add_statement (new CCodeExpressionStatement (new CCodeAssignment (new CCodeMemberAccess.pointer (new CCodeCastExpression (new CCodeIdentifier ("%s_type".printf (get_ccode_lower_case_name (st))), "AroopObject *"), "type"), new CCodeFunctionCall (new CCodeIdentifier ("aroop_type_type_get")))));

		var set_base_type = new CCodeFunctionCall (new CCodeIdentifier ("aroop_type_set_base_type"));
		...
		var base_size = new CCodeFunctionCall (new CCodeIdentifier ("aroop_type_get_object_size"));
		...
		set_size = new CCodeFunctionCall (new CCodeIdentifier ("aroop_type_set_value_size"));
		set_size.add_argument (new CCodeIdentifier ("%s_type".printf (get_ccode_lower_case_name (st))));
		...
		// workaround: set value_size again as it is currently overwritten by aroop_object_type_init
		set_size = new CCodeFunctionCall (new CCodeIdentifier ("aroop_type_set_value_size"));
		set_size.add_argument (new CCodeIdentifier ("%s_type".printf (get_ccode_lower_case_name (st))));
		set_size.add_argument (sizeof_call);
		type_init_block.add_statement (new CCodeExpressionStatement (set_size));
		...
		type_init_call = new CCodeFunctionCall (new CCodeIdentifier ("aroop_value_type_init"));
		...
		var value_to_any_fun = new CCodeFunction ("%s_value_to_any".printf (get_ccode_lower_case_name (st)), "AroopObject*");
		...
		cdecl = new CCodeDeclaration ("AroopObject *");
